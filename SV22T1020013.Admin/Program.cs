...
builder.Services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
                .AddCookie(option =>
                {
                    ...
                    // Khi dùng [Authorize(Roles="...")] mà user không đủ quyền, 
                    // trình duyệt sẽ tự chuyển hướng về Action này.
...
// LƯU Ý THỨ TỰ: Authentication (Ai?) phải đứng trước Authorization (Được làm gì?)
...
SV22T1020013.BusinessLayers.Configuration.Initialize(connectionString);
